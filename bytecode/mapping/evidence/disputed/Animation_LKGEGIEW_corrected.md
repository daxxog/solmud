...
grep -A 5 -B 5 "public static.*anims\[\]" srcAllDummysRemoved/src/Animation.java

# Verify static array in javap cache
grep -A 3 -B 3 "public static.*LKGEGIEW\[" srcAllDummysRemoved/.javap_cache/Animation.javap.cache
```
...
grep -A 15 -B 3 "anIntArray353\|anIntArray354\|anIntArray355" srcAllDummysRemoved/.javap_cache/Animation.javap.cache
```
...
grep -A 10 -B 5 "XTGLDHGX.*getDataForName" bytecode/client/LKGEGIEW.bytecode.txt

# Show StreamLoader integration in DEOB source
grep -A 10 -B 5 "streamLoader\.getDataForName" srcAllDummysRemoved/src/Animation.java

# Verify StreamLoader method calls in javap cache
grep -A 10 -B 5 "getDataForName" srcAllDummysRemoved/.javap_cache/Animation.javap.cache
```
