...
grep -c "^\s*int\s\+\w\+;" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt
# Expected: 19 int fields

# Verify no other field types
grep -v "int.*;" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt | grep "^\s*.*\s\+\w\+;" | wc -l
# Expected: 0 (no boolean, byte, etc. fields)

# Verify Class21 field structure
grep -c "^\s*int\s\+\w\+;" /Users/daxxog/Desktop/solmud/srcAllDummysRemoved/src/Class21.java
# Expected: 19 int fields
```
...
grep -c "public.*(" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt
# Expected: 1 (just constructor)

# Verify constructor assigns all 19 fields
grep -c "putfield.*:I" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt
# Expected: 19 field assignments

# Verify Class21 has similar minimal structure
grep -c "public.*(" /Users/daxxog/Desktop/solmud/srcAllDummysRemoved/src/Class21.java
# Expected: 1 (just constructor)
```
...
grep -E "public ZARDZRHZ.*\(.*int.*\)" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt | wc -l
# Expected: 1 constructor with 19 int parameters

# Count putfield operations in constructor
grep -A 50 "public ZARDZRHZ" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt | grep -c "putfield.*:I"
# Expected: 19 field assignments
```
...
grep -c -E "(iadd|isub|imul|idiv|fadd|fsub|fmul|fdiv)" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt
# Expected: 0 (no arithmetic operations)

# Verify no loops or conditionals beyond field assignment
grep -c -E "(if_|goto|tableswitch|lookupswitch)" /Users/daxxog/Desktop/solmud/bytecode/client/ZARDZRHZ.bytecode.txt
