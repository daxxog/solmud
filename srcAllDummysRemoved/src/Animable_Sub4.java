...
final class Animable_Sub4 extends Animable {
    ...
    public void method455(int i, int j, int k, int l) {
        ...
        if (!aBoolean1579) aDouble1577 = -aDouble1576 * Math.tan((double) anInt1588 * 0.02454369D);
    ...
    public Model getRotatedModel() {
        ...
        if (aSpotAnim_1592.anInt410 != 128 || aSpotAnim_1592.anInt411 != 128)
            model_1.method478(
                    aSpotAnim_1592.anInt410, aSpotAnim_1592.anInt410, aSpotAnim_1592.anInt411);
        model_1.method474(anInt1596);
        model_1.method479(
                64 + aSpotAnim_1592.anInt413, 850 + aSpotAnim_1592.anInt414, -30, -50, -30, true);
        return model_1;
    }

    public Animable_Sub4(
    ...
    public void method456(int i) {
        ...
        anInt1595 =
                (int) (Math.atan2(aDouble1574, aDouble1575) * 325.94900000000001D) + 1024 & 0x7ff;
        ...
        if (aSpotAnim_1592.aAnimation_407 != null)
            for (anInt1594 += i; anInt1594 > aSpotAnim_1592.aAnimation_407.method258(anInt1593); ) {
                ...
                anInt1593++;
                if (anInt1593 >= aSpotAnim_1592.aAnimation_407.anInt352) anInt1593 = 0;
            }
    }
