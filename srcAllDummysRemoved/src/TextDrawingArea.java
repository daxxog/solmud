...
public final class TextDrawingArea extends DrawingArea {
        ...
        for (int i1 = 0; i1 < s.length(); i1++) {
            ...
            if (c != ' ')
                method392(
                        ...
                        l
                                + anIntArray1495[c]
                                + (int) (Math.sin((double) i1 / 2D + (double) k / 5D) * 5D),
                        anIntArray1492[c],
                        anIntArray1493[c],
                        i);
            j += anIntArray1496[c];
        ...
        for (int i1 = 0; i1 < s.length(); i1++) {
            ...
            if (c != ' ')
                method392(
                        ...
                        i
                                + anIntArray1494[c]
                                + (int) (Math.sin((double) i1 / 5D + (double) j / 5D) * 5D),
                        k
                                + anIntArray1495[c]
                                + (int) (Math.sin((double) i1 / 3D + (double) j / 5D) * 5D),
                        anIntArray1492[c],
                        anIntArray1493[c],
                        l);
            i += anIntArray1496[c];
        ...
        for (int k1 = 0; k1 < s.length(); k1++) {
            ...
            if (c != ' ')
                method392(
                        ...
                        k
                                + anIntArray1495[c]
                                + (int) (Math.sin((double) k1 / 1.5D + (double) j) * d),
                        anIntArray1492[c],
                        anIntArray1493[c],
                        i1);
            l += anIntArray1496[c];
    ...
    private void method392(byte abyte0[], int i, int j, int k, int l, int i1) {
        ...
        if (j + l >= DrawingArea.bottomY) l -= ((j + l) - DrawingArea.bottomY) + 1;
    ...
    private void method394(int i, int j, byte abyte0[], int k, int l, int i1, int j1) {
        ...
        if (l + i1 >= DrawingArea.bottomY) i1 -= ((l + i1) - DrawingArea.bottomY) + 1;
        ...
        for (int j2 = -i; j2 < 0; j2++) {
            for (int k2 = -i1; k2 < 0; k2++)
                if (abyte0[l++] != 0) {
                    int l2 = ai[j];
                    ai[j++] =
                            (((l2 & 0xff00ff) * i2 & 0xff00ff00) + ((l2 & 0xff00) * i2 & 0xff0000)
                                            >> 8)
                                    + l1;
                } else {
                    j++;
