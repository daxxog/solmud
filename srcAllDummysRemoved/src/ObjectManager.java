...
final class ObjectManager {
                ...
                for (int k3 = 0; k3 <= anInt147; k3++) {
                    for (int i4 = 0; i4 <= anInt146; i4++) {
                        if ((anIntArrayArrayArray135[i3][i4][k3] & i2) != 0) {
                            ...
                            int k8 = i3;
                            for (;
                                    k4 > 0 && (anIntArrayArrayArray135[i3][i4][k4 - 1] & i2) != 0;
                                    k4--)
                                ;
                            for (;
                                    l5 < anInt147
                                            && (anIntArrayArrayArray135[i3][i4][l5 + 1] & i2) != 0;
                                    l5++)
                                ;
                            label0:
                            for (; i7 > 0; i7--) {
                        ...
                        if ((anIntArrayArrayArray135[i3][i4][k3] & j2) != 0) {
                            ...
                            int l8 = i3;
                            for (;
                                    l4 > 0 && (anIntArrayArrayArray135[i3][l4 - 1][k3] & j2) != 0;
                                    l4--)
                                ;
                            for (;
                                    i6 < anInt146
                                            && (anIntArrayArrayArray135[i3][i6 + 1][k3] & j2) != 0;
                                    i6++)
                                ;
                            label2:
                            for (; j7 > 0; j7--) {
                        ...
                        if ((anIntArrayArrayArray135[i3][i4][k3] & k2) != 0) {
                            ...
                            int i9 = k3;
                            for (;
                                    k7 > 0 && (anIntArrayArrayArray135[i3][i4][k7 - 1] & k2) != 0;
                                    k7--)
                                ;
                            for (;
                                    i9 < anInt147
                                            && (anIntArrayArrayArray135[i3][i4][i9 + 1] & k2) != 0;
                                    i9++)
                                ;
                            label4:
                            for (; i5 > 0; i5--) {
    ...
    private static int method172(int i, int j) {
        int k =
                (method176(i + 45365, j + 0x16713, 4) - 128)
    ...
    private void method175(
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                if (worldController.method284(
                                l2, byte0, k2, l4, ((Animable) (obj1)), j4, k, i5, i, l)
                        && class46.aBoolean779) {
                    Model model;
            ...
            if (class46.aBoolean767 && class11 != null)
                class11.method212(
                        class46.aBoolean757, class46.anInt744, class46.anInt761, l, i, j1);
            return;
        }
        if (j >= 12) {
            Object obj2;
    ...
    public final void method180(byte abyte0[], int i, int j, int k, int l, Class11 aclass11[]) {
        ...
        for (int l1 = 0; l1 < 4; l1++) {
            for (int i2 = 0; i2 < 64; i2++) {
                for (int j2 = 0; j2 < 64; j2++) method181(j2 + i, l, stream, i2 + j, l1, 0, k);
            }
        }
    }
    ...
    private void method181(int i, int j, Stream stream, int k, int l, int i1, int k1) {
        if (k >= 0 && k < 104 && i >= 0 && i < 104) {
            ...
            do {
                ...
                if (l1 == 0)
                    if (l == 0) {
                        anIntArrayArrayArray129[0][k][i] =
                                -method172(0xe3b7b + k + k1, 0x87cce + i + j) * 8;
                        return;
                    } else {
                        anIntArrayArrayArray129[l][k][i] =
                                anIntArrayArrayArray129[l - 1][k][i] - 240;
                        return;
                    }
                if (l1 == 1) {
                    ...
                    if (l == 0) {
                        ...
                        anIntArrayArrayArray129[l][k][i] =
                                anIntArrayArrayArray129[l - 1][k][i] - j2 * 8;
                        return;
                    }
                }
                if (l1 <= 49) {
    ...
    public static void method188(
        ...
        if (k == 10 || k == 11) {
            ...
            if (obj1 != null) {
                ...
                worldController.method284(
                        i3, byte1, l2, i5, ((Animable) (obj1)), k4, k1, j5, j, i1);
            }
            if (class46.aBoolean767)
                class11.method212(
                        class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
            return;
        }
        if (k >= 12) {
            Object obj2;
