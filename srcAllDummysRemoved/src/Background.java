...
public final class Background extends DrawingArea {
    ...
    public void method356() {
        ...
        for (int j = 0; j < anInt1453; j++) {
            for (int k = 0; k < anInt1452; k++)
                abyte0[(k + anInt1454 >> 1) + (j + anInt1455 >> 1) * anInt1456] =
                        aByteArray1450[i++];
        }
    ...
    public void method357() {
        if (anInt1452 == anInt1456 && anInt1453 == anInt1457) return;
        byte abyte0[] = new byte[anInt1456 * anInt1457];
        int i = 0;
        for (int j = 0; j < anInt1453; j++) {
            for (int k = 0; k < anInt1452; k++)
    ...
    public void method359() {
        ...
        for (int j = anInt1453 - 1; j >= 0; j--) {
            for (int k = 0; k < anInt1452; k++) abyte0[i++] = aByteArray1450[k + j * anInt1452];
        }
    ...
    private void method362(
        ...
        for (int l1 = -i; l1 < 0; l1++) {
            for (int i2 = k1; i2 < 0; i2++) {
                ...
                if (byte1 != 0) ai[k++] = ai1[byte1 & 0xff];
                else k++;
                byte1 = abyte0[i1++];
                if (byte1 != 0) ai[k++] = ai1[byte1 & 0xff];
                else k++;
            ...
            for (int j2 = l; j2 < 0; j2++) {
                ...
                if (byte2 != 0) ai[k++] = ai1[byte2 & 0xff];
                else k++;
            }
