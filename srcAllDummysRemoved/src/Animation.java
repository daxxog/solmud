...
public final class Animation {
    ...
    public static void unpackConfig(StreamLoader streamLoader) {
        ...
        if (anims == null) anims = new Animation[length];
        for (int j = 0; j < length; j++) {
            if (anims[j] == null) anims[j] = new Animation();
    ...
    public int method258(int i) {
        ...
        if (j == 0) {
            ...
            if (class36 != null) j = anIntArray355[i] = class36.anInt636;
        }
        if (j == 0) j = 1;
        return j;
    }
        ...
        do {
            ...
            if (i == 1) {
                ...
                for (int j = 0; j < anInt352; j++) {
                    ...
                    if (anIntArray354[j] == 65535) anIntArray354[j] = -1;
