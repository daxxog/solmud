...
public class client extends RSApplet {
    ...
    private void method22() {
        try {
                            ...
                            if (i10 != -1) {
                                ...
                                for (int k12 = 0; k12 < anIntArray1234.length; k12++) {
                                    if (anIntArray1234[k12] != j12
                                            || aByteArrayArray1247[k12] == null) continue;
                                    objectManager.method183(
                                            aClass11Array1230,
                                            worldController,
                                            k10,
                                            j8 * 8,
            ...
            if (lowMem) worldController.method275(ObjectManager.anInt145);
            else worldController.method275(0);
            ...
            for (int l2 = 0; l2 < 104; l2++) {
                ...
                if (i3 != 0) {
                    ...
                    if (j3 >= 0) {
                        int k3 = k2;
                        int l3 = l2;
                        if (j3 != 22 && j3 != 29 && j3 != 34 && j3 != 36 && j3 != 46 && j3 != 47
                                && j3 != 48) {
                            byte byte0 = 104;
                            byte byte1 = 104;
                            ...
                            for (int i4 = 0; i4 < 10; i4++) {
                                ...
                                if (j4 == 0
                                        && k3 > 0
                                        && k3 > k2 - 3
                                        && (ai1[k3 - 1][l3] & 0x1280108) == 0) k3--;
                                if (j4 == 1
                                        && k3 < byte0 - 1
                                        && k3 < k2 + 3
                                        && (ai1[k3 + 1][l3] & 0x1280180) == 0) k3++;
                                if (j4 == 2
                                        && l3 > 0
                                        && l3 > l2 - 3
                                        && (ai1[k3][l3 - 1] & 0x1280102) == 0) l3--;
                                if (j4 == 3
                                        && l3 < byte1 - 1
                                        && l3 < l2 + 3
                                        && (ai1[k3][l3 + 1] & 0x1280120) == 0) l3++;
                            }
                        }
    ...
    private void spawnGroundItem(int i, int j) {
        ...
        int k = 0xfa0a1f01;
        Object obj = null;
        for (Item item = (Item) class19.reverseGetFirst();
                item != null;
                item = (Item) class19.reverseGetNext()) {
            ItemDef itemDef = ItemDef.forID(item.ID);
            int l = itemDef.value;
            if (itemDef.stackable) l *= item.anInt1559 + 1;
        ...
        Object obj1 = null;
        Object obj2 = null;
        for (Item class30_sub2_sub4_sub2_1 = (Item) class19.reverseGetFirst();
            ...
            if (class30_sub2_sub4_sub2_1.ID != ((Item) (obj)).ID
                    ...
                    && obj2 == null) obj2 = class30_sub2_sub4_sub2_1;
        }

        int i1 = i + (j << 7) + 0x60000000;
        worldController.method281(
                i,
                i1,
                ((Animable) (obj1)),
    ...
    private void method26(boolean flag) {
        for (int j = 0; j < npcCount; j++) {
            ...
            worldController.method285(
                    plane,
                    npc.anInt1552,
                    method42(plane, npc.y, npc.x),
                    k,
                    npc.y,
                    (npc.anInt1540 - 1) * 64 + 60,
                    npc.x,
                    npc,
                    npc.aBoolean1541);
        }
    ...
    private void buildInterfaceMenu(int i, RSInterface class9, int k, int l, int i1, int j1) {
        if (class9.type != 0 || class9.children == null || class9.aBoolean266) return;
        ...
        for (int l1 = 0; l1 < k1; l1++) {
            ...
            if ((class9_1.anInt230 >= 0 || class9_1.anInt216 != 0)
                ...
                if (class9_1.anInt230 >= 0) anInt886 = class9_1.anInt230;
                else anInt886 = class9_1.id;
            if (class9_1.type == 0) {
                ...
                if (class9_1.atActionType == 1
                        ...
                        && i1 < j2 + class9_1.height) {
                    boolean flag = false;
                    if (class9_1.anInt214 != 0) flag = buildFriendsListMenu(class9_1);
                    if (!flag) {
                                                ...
                                                if (class9_1.actions[j4] != null) {
                                                    menuActionName[menuActionRow] =
                                                            class9_1.actions[j4]
                                                                    + " @lre@"
                                                                    + itemDef.name;
                                                    if (j4 == 0) menuActionID[menuActionRow] = 632;
    ...
    private void processChatModeClick() {
        if (super.clickMode3 == 1) {
                ...
                if (openInterfaceID == -1) {
                    ...
                    for (int i = 0; i < RSInterface.interfaceCache.length; i++) {
                        if (RSInterface.interfaceCache[i] == null
                                || RSInterface.interfaceCache[i].anInt214 != 600) continue;
            ...
            if (anInt940 > 1386) {
                ...
                if ((int) (Math.random() * 2D) == 0) stream.writeWord(47234);
                if ((int) (Math.random() * 2D) == 0) stream.writeWordBigEndian(21);
    ...
    private void updateEntities() {
        try {
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                Object obj;
                if (j == -1) obj = myPlayer;
                else if (j < playerCount) obj = playerArray[playerIndices[j]];
                else obj = npcArray[npcIndices[j - playerCount]];
                ...
                if (((Entity) (obj)).textSpoken != null
                    ...
                    if (spriteDrawX > -1 && anInt974 < anInt975) {
                        anIntArray979[anInt974] =
                                chatTextDrawingArea.method384(((Entity) (obj)).textSpoken) / 2;
                ...
                if (((Entity) (obj)).loopCycleStatus > loopCycle) {
                    try {
                        ...
                        if (spriteDrawX > -1) {
                            int i1 =
                                    (((Entity) (obj)).currentHealth * 30)
                                            / ((Entity) (obj)).maxHealth;
                            if (i1 > 30) i1 = 30;
                            DrawingArea.method336(5, spriteDrawY - 3, spriteDrawX - 15, 65280, i1);
                            DrawingArea.method336(
                                    5, spriteDrawY - 3, (spriteDrawX - 15) + i1, 0xff0000, 30 - i1);
                        }
                    } catch (Exception e) {
                    }
                }
                for (int j1 = 0; j1 < 4; j1++)
                    if (((Entity) (obj)).hitsLoopCycle[j1] > loopCycle) {
                        ...
                        if (spriteDrawX > -1) {
                            ...
                            hitMarks[((Entity) (obj)).hitMarkTypes[j1]].drawSprite(
                                    spriteDrawX - 12, spriteDrawY - 12);
                            aTextDrawingArea_1270.drawText(
                                    0,
            ...
            for (int k = 0; k < anInt974; k++) {
                ...
                if (anInt1249 == 0) {
                    ...
                    if (anIntArray980[k] == 9) {
                        ...
                        if (j3 < 50) i3 = 0xff0000 + 1280 * j3;
                        else if (j3 < 100) i3 = 0xffff00 - 0x50000 * (j3 - 50);
                        else if (j3 < 150) i3 = 65280 + 5 * (j3 - 100);
                    }
                    if (anIntArray980[k] == 10) {
                        int k3 = 150 - anIntArray982[k];
                        if (k3 < 50) i3 = 0xff0000 + 5 * k3;
                        else if (k3 < 100) i3 = 0xff00ff - 0x50000 * (k3 - 50);
                        else if (k3 < 150) i3 = (255 + 0x50000 * (k3 - 100)) - 5 * (k3 - 100);
                    }
                    if (anIntArray980[k] == 11) {
                        int l3 = 150 - anIntArray982[k];
                        if (l3 < 50) i3 = 0xffffff - 0x50005 * l3;
                        else if (l3 < 100) i3 = 65280 + 0x50005 * (l3 - 50);
                    ...
                    if (anIntArray981[k] == 1) {
                        chatTextDrawingArea.method386(
                                0, s, spriteDrawX, anInt1265, spriteDrawY + 1);
                        chatTextDrawingArea.method386(i3, s, spriteDrawX, anInt1265, spriteDrawY);
                    }
                    if (anIntArray981[k] == 2) {
                        chatTextDrawingArea.method387(
                                spriteDrawX, s, anInt1265, spriteDrawY + 1, 0);
                        chatTextDrawingArea.method387(spriteDrawX, s, anInt1265, spriteDrawY, i3);
                    }
                    if (anIntArray981[k] == 3) {
                        chatTextDrawingArea.method388(
                                150 - anIntArray982[k],
                                s,
                                anInt1265,
                                spriteDrawY + 1,
                                ...
                                0);
                        chatTextDrawingArea.method388(
                                150 - anIntArray982[k], s, anInt1265, spriteDrawY, spriteDrawX, i3);
                    }
                    if (anIntArray981[k] == 4) {
                        int i4 = chatTextDrawingArea.method384(s);
                        int k4 = ((150 - anIntArray982[k]) * (i4 + 100)) / 150;
                        DrawingArea.setDrawingArea(334, spriteDrawX - 50, spriteDrawX + 50, 0);
                        chatTextDrawingArea.method385(
                                0, s, spriteDrawY + 1, (spriteDrawX + 50) - k4);
        ...
        if (!lowMem) {
            if (Texture.anIntArray1480[17] >= j) {
                ...
                if (anInt854 > 1235) {
                    ...
                    stream.writeWordBigEndian((int) (Math.random() * 256D));
                    if ((int) (Math.random() * 2D) == 0) stream.writeWord(51825);
                    stream.writeWordBigEndian((int) (Math.random() * 256D));
                    stream.writeWord((int) (Math.random() * 65536D));
    ...
    private void method38() {
        for (int i = -1; i < playerCount; i++) {
            int j;
            if (i == -1) j = myPlayerIndex;
            else j = playerIndices[i];
    ...
    private void addFriend(long l) {
        try {
            ...
            signlink.reporterror(
                    "15283, " + (byte) 68 + ", " + l + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    private int method42(int i, int j, int k) {
        ...
        int j2 =
                intGroundArray[j1][l][i1 + 1] * (128 - k1) + intGroundArray[j1][l + 1][i1 + 1] * k1
                        >> 7;
    ...
    private static String intToKOrMil(int j) {
        ...
        if (j < 0x989680) return j / 1000 + "K";
        else return j / 0xf4240 + "M";
    }
    ...
    public void processGameLoop() {
        ...
        loopCycle++;
        if (!loggedIn) processLoginScreenInput();
        else mainGameProcessor();
    ...
    private boolean promptUserForInput(RSInterface class9) {
        ...
        if (j >= 300 && j <= 313) {
            ...
            if (i2 != -1) {
                do {
                    if (j1 == 0 && --i2 < 0) i2 = IDK.length - 1;
                    if (j1 == 1 && ++i2 >= IDK.length) i2 = 0;
        ...
        if (j == 326) {
            ...
            for (int i1 = 0; i1 < 7; i1++) stream.writeWordBigEndian(anIntArray1065[i1]);

            for (int l1 = 0; l1 < 5; l1++) stream.writeWordBigEndian(anIntArray990[l1]);
    ...
    private void method49(Stream stream) {
        for (int j = 0; j < anInt893; j++) {
            ...
            if ((l & 0x40) != 0) l += stream.readUnsignedByte() << 8;
        ...
        if (k1 != 0) {
            ...
            if (class46_2.anInt758 != -1) {
                ...
                if (background_2 != null) {
                    ...
                    background_2.method361(
                            48 + l * 4 + i6, 48 + (104 - i - class46_2.anInt761) * 4 + j6);
                }
            } else {
                if (i3 == 0 || i3 == 2)
                    if (k2 == 0) {
                ...
                if (i3 == 3)
                    if (k2 == 0) ai[k4] = k3;
                    else if (k2 == 1) ai[k4 + 3] = k3;
                    else if (k2 == 2) ai[k4 + 3 + 1536] = k3;
        ...
        if (k1 != 0) {
            ...
            if (class46_1.anInt758 != -1) {
                ...
                if (background_1 != null) {
                    ...
                    background_1.method361(
                            48 + l * 4 + j5, 48 + (104 - i - class46_1.anInt761) * 4 + k5);
                }
            } else if (j3 == 9) {
                int l4 = 0xeeeeee;
                if (k1 > 0) l4 = 0xee0000;
        ...
        if (k1 != 0) {
            ...
            if (class46.anInt758 != -1) {
                ...
                if (background != null) {
                    ...
                    background.method361(
                            48 + l * 4 + i4, 48 + (104 - i - class46.anInt761) * 4 + j4);
                }
            }
        }
    }
    ...
    private void loadTitleScreen() {
        ...
        System.arraycopy(
                aRSImageProducer_1110.anIntArray315,
                0,
                aClass30_Sub2_Sub1_Sub1_1201.myPixels,
                0,
                33920);

        System.arraycopy(
                aRSImageProducer_1111.anIntArray315,
                0,
                aClass30_Sub2_Sub1_Sub1_1202.myPixels,
                0,
                33920);
    ...
    private void method55() {
        for (Animable_Sub4 class30_sub2_sub4_sub4 = (Animable_Sub4) aClass19_1013.reverseGetFirst();
                class30_sub2_sub4_sub4 != null;
                class30_sub2_sub4_sub4 = (Animable_Sub4) aClass19_1013.reverseGetNext())
            if (class30_sub2_sub4_sub4.anInt1597 != plane
                ...
                if (class30_sub2_sub4_sub4.anInt1590 < 0) {
                    ...
                    Player player;
                    if (j == unknownInt10) player = myPlayer;
                    else player = playerArray[j];
                    if (player != null
                            && player.x >= 0
                            && player.x < 13312
                            && player.y >= 0
                ...
                worldController.method285(
                        ...
                        (int) class30_sub2_sub4_sub4.aDouble1587,
                        -1,
                        (int) class30_sub2_sub4_sub4.aDouble1586,
                        60,
    ...
    public AppletContext getAppletContext() {
        if (signlink.mainapp != null) return signlink.mainapp.getAppletContext();
        else return super.getAppletContext();
    }
        ...
        do {
            ...
            do {
                ...
                if (onDemandData.dataType == 2
                        ...
                        && onDemandData.buffer != null) saveMidi(songChanging, onDemandData.buffer);
    ...
    private void mainGameProcessor() {
            ...
            if (flagged) {
                if (super.clickMode3 != 0 || mouseDetection.coordsIndex >= 40) {
                    ...
                    for (int j4 = 0; j4 < mouseDetection.coordsIndex; j4++) {
                        ...
                        if (l4 < 0) l4 = 0;
                        else if (l4 > 502) l4 = 502;
                        int k5 = mouseDetection.coordsX[j4];
                        if (k5 < 0) k5 = 0;
                        else if (k5 > 764) k5 = 764;
                        int i6 = l4 * 765 + k5;
        ...
        if (super.keyArray[1] == 1
                || super.keyArray[2] == 1
                || super.keyArray[3] == 1
                || super.keyArray[4] == 1) aBoolean1017 = true;
        ...
        if (activeInterfaceType != 0) {
            ...
            if (super.mouseX > anInt1087 + 5
                    ...
                    || super.mouseY < anInt1088 - 5) aBoolean1242 = true;
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 5) {
                    ...
                    if (lastActiveInvInterface == anInt1084
                        ...
                        int j1 = 0;
                        if (anInt913 == 1 && class9.anInt214 == 206) j1 = 1;
                        if (class9.inv[mouseInvInterfaceIndex] <= 0) j1 = 0;
                        ...
                        && menuActionRow > 2) determineMenuSize();
                else if (menuActionRow > 0) doAction(menuActionRow - 1);
    ...
    void drawLoadingText(int i, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        chatTextDrawingArea.drawText(
                0xffffff, "RuneScape is loading - please wait...", c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
    ...
    private void method65(
            int i, int j, int k, int l, RSInterface class9, int i1, boolean flag, int j1) {
        int anInt992;
        if (aBoolean972) anInt992 = 32;
        else anInt992 = 0;
        aBoolean972 = false;
    ...
    private StreamLoader streamLoaderForName(int i, String s, String s1, int j, int k) {
        ...
        int l = 5;
        try {
            if (decompressors[0] != null) abyte0 = decompressors[0].decompress(i);
        } catch (Exception _ex) {
        }
        if (abyte0 != null) {
            //		aCRC32_930.reset();
        ...
        while (abyte0 == null) {
            ...
            try {
                ...
                while (j2 < i2) {
                    ...
                    j2 += j3;
                    int k3 = (j2 * 100) / i2;
                    if (k3 != k1) drawLoadingText(k, "Loading " + s + " - " + k3 + "%");
                    k1 = k3;
                }
                datainputstream.close();
                try {
                ...
                */
                ...
                if (s2.equals("Unknown error")) s2 = "Connection error";
                abyte0 = null;
    ...
    private void dropClient() {
        ...
        aTextDrawingArea_1271.drawText(
                0xffffff, "Please wait - attempting to reestablish", 158, 256);
        aRSImageProducer_1165.drawGraphics(4, super.graphics, 4);
        anInt1021 = 0;
        destX = 0;
    ...
    private void doAction(int i) {
        ...
        if (l == 315) {
            ...
            boolean flag8 = true;
            if (class9.anInt214 > 0) flag8 = promptUserForInput(class9);
            if (flag8) {
        ...
        if (l == 516)
            if (!menuOpen) worldController.method312(super.saveClickY - 4, super.saveClickX - 4);
            else worldController.method312(k - 4, j - 4);
        if (l == 1062) {
            anInt924 += baseX;
            if (anInt924 >= 113) {
            ...
            if (l1 != -1) {
                ...
                for (int j3 = 0; j3 < playerCount; j3++) {
                    ...
                    if (class30_sub2_sub4_sub1_sub2_7 == null
                            ...
                            || !class30_sub2_sub4_sub1_sub2_7.name.equalsIgnoreCase(s7)) continue;
                    doWalkTo(
                            2,
                            0,
                            1,
        ...
        if (l == 626) {
            ...
            if (s4.indexOf(" ") != -1) s4 = s4.substring(0, s4.indexOf(" "));
        ...
        if (l == 1025) {
            ...
            if (class30_sub2_sub4_sub1_sub1_5 != null) {
                ...
                if (entityDef != null) {
                    String s9;
                    if (entityDef.description != null) s9 = new String(entityDef.description);
                    else s9 = "It's a " + entityDef.name + ".";
                    pushMessage(s9, 0, "");
                }
            }
        }
                ...
                if (openInterfaceID == -1) {
                    ...
                    for (int i3 = 0; i3 < RSInterface.interfaceCache.length; i3++) {
                        if (RSInterface.interfaceCache[i3] == null
                                || RSInterface.interfaceCache[i3].anInt214 != 600) continue;
                        reportAbuseInterfaceID =
                                openInterfaceID = RSInterface.interfaceCache[i3].parentID;
                        break;
                    }
        ...
        if (l == 1125) {
            ...
            else if (itemDef.description != null) s5 = new String(itemDef.description);
            else s5 = "It's a " + itemDef.name + ".";
            pushMessage(s5, 0, "");
        }
        if (l == 169) {
            stream.createFrame(185);
        ...
        if (l == 1226) {
            ...
            String s10;
            if (class46.description != null) s10 = new String(class46.description);
            else s10 = "It's a " + class46.name + ".";
            pushMessage(s10, 0, "");
        }
        if (l == 244) {
            boolean flag7 =
        ...
        if (l == 1448) {
            ...
            String s6;
            if (itemDef_1.description != null) s6 = new String(itemDef_1.description);
            else s6 = "It's a " + itemDef_1.name + ".";
            pushMessage(s6, 0, "");
        }
        itemSelected = 0;
        spellSelected = 0;
    ...
    private void build3dScreenMenu() {
        ...
        for (int k = 0; k < Model.anInt1687; k++) {
            ...
            if (k1 == 2 && worldController.method304(plane, i1, j1, l) >= 0) {
                ...
                if (itemSelected == 1) {
                    menuActionName[menuActionRow] =
                            "Use " + selectedItemName + " with @cya@" + class46.name;
                    ...
                    if (class46.actions != null) {
                        for (int i2 = 4; i2 >= 0; i2--)
                            if (class46.actions[i2] != null) {
                                menuActionName[menuActionRow] =
                                        class46.actions[i2] + " @cya@" + class46.name;
                ...
                if ((player.x & 0x7f) == 64 && (player.y & 0x7f) == 64) {
                    for (int k2 = 0; k2 < npcCount; k2++) {
                        ...
                        if (class30_sub2_sub4_sub1_sub1_2 != null
                            ...
                            buildAtNPCMenu(
                                    class30_sub2_sub4_sub1_sub1_2.desc, npcIndices[k2], j1, i1);
                    }
                    ...
                    for (int i3 = 0; i3 < playerCount; i3++) {
                        ...
                        if (class30_sub2_sub4_sub1_sub2_2 != null
                            ...
                            buildAtPlayerMenu(
                                    i1, playerIndices[i3], class30_sub2_sub4_sub1_sub2_2, j1);
                    }
                }
            ...
            if (k1 == 3) {
                ...
                if (class19 != null) {
                    for (Item item = (Item) class19.getFirst();
                            item != null;
    ...
    Component getGameComponent() {
        ...
        if (super.gameFrame != null) return super.gameFrame;
        else return this;
    }
        ...
        do {
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if ((j >= 97 && j <= 122 || j >= 65 && j <= 90 || j >= 48 && j <= 57 || j == 32)
                        && reportAbuseInput.length() < 12) reportAbuseInput += (char) j;
                ...
                if (j == 13 || j == 10) {
                    ...
                    if (friendsListAction == 3 && promptInput.length() > 0) {
                        ...
                        pushMessage(
                                promptInput, 6, TextClass.fixName(TextClass.nameForLong(aLong953)));
                ...
                if (j == 8 && amountOrNameInput.length() > 0) {
                    amountOrNameInput =
                            amountOrNameInput.substring(0, amountOrNameInput.length() - 1);
                    inputTaken = true;
                }
                if (j == 13 || j == 10) {
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    if (myPrivilege == 2) {
                        if (inputString.equals("::clientdrop")) dropClient();
                        if (inputString.equals("::lag")) printDebug();
                        ...
                        if (inputString.equals("::fpson")) fpsOn = true;
                        if (inputString.equals("::fpsoff")) fpsOn = false;
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
        ...
        if (j >= 101 && j <= 200 || j >= 801 && j <= 900) {
            ...
            if (friendsNodeIDs[j] == 0) class9.message = "@red@Offline";
            else if (friendsNodeIDs[j] == nodeID)
                class9.message = "@gre@World-" + (friendsNodeIDs[j] - 9);
            else class9.message = "@yel@World-" + (friendsNodeIDs[j] - 9);
            class9.atActionType = 1;
            return;
        }
        if (j == 203) {
        ...
        if (j == 327) {
            ...
            if (aBoolean1031) {
                for (int k1 = 0; k1 < 7; k1++) {
                    ...
                    if (l1 >= 0 && !IDK.cache[l1].method537()) return;
                }
                ...
                for (int j2 = 0; j2 < 7; j2++) {
                    ...
                    if (k2 >= 0) aclass30_sub2_sub4_sub6s[i2++] = IDK.cache[k2].method538();
                }
        ...
        if (j == 650 || j == 655)
            if (anInt1193 != 0) {
                String s;
                if (daysSinceLastLogin == 0) s = "earlier today";
                else if (daysSinceLastLogin == 1) s = "yesterday";
        ...
        if (j == 652)
            if (daysSinceRecovChange == 201) {
                ...
                String s1;
                if (daysSinceRecovChange == 0) s1 = "Earlier today";
                else if (daysSinceRecovChange == 1) s1 = "Yesterday";
                else s1 = daysSinceRecovChange + " days ago";
    ...
    private String getDocumentBaseHost() {
        ...
        if (super.gameFrame != null) return "";
        else return "";
    }
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            if (k == 0) {
                ...
                else aStream_847.writeWordBigEndian(16);
                ...
                for (int l1 = 0; l1 < 9; l1++) aStream_847.writeDWord(expectedCRCs[l1]);
            ...
            if (k == 2) {
                ...
                menuOpen = false;
                super.idleTime = 0;
                for (int j1 = 0; j1 < 100; j1++) chatMessages[j1] = null;
    ...
    private boolean doWalkTo(
        ...
        while (i4 != l3) {
            ...
            if (i1 != 0) {
                if ((i1 < 5 || i1 == 10)
                        && aClass11Array1230[plane].method219(k2, j3, k3, j, i1 - 1, i2)) {
                    flag1 = true;
                    break;
                }
            ...
            if (k1 != 0
                    && k != 0
                    && aClass11Array1230[plane].method221(i2, k2, j3, k, l1, k1, k3)) {
                flag1 = true;
                break;
            }
            int l4 = anIntArrayArray825[j3][k3] + 1;
            if (j3 > 0
                    && anIntArrayArray901[j3 - 1][k3] == 0
        ...
        bigY[i4++] = k3;
        int l5;
        for (int j5 = l5 = anIntArrayArray901[j3][k3];
                j3 != j2 || k3 != j1;
                j5 = anIntArrayArray901[j3][k3]) {
            if (j5 != l5) {
                l5 = j5;
                bigX[i4] = j3;
                bigY[i4++] = k3;
            ...
            if (entityDef.actions != null) {
                for (int i1 = 4; i1 >= 0; i1--)
                    if (entityDef.actions[i1] != null
                        ...
                        char c = '\0';
                        if (entityDef.combatLevel > myPlayer.combatLevel) c = '\u07D0';
                ...
                if (atPlayerActions[l] != null) {
                    ...
                    if (atPlayerActions[l].equalsIgnoreCase("attack")) {
                        ...
                        if (myPlayer.team != 0 && player.team != 0)
                            if (myPlayer.team == player.team) c = '\u07D0';
                            else c = '\0';
    ...
    private void method89(Class30_Sub1 class30_sub1) {
        ...
        if (class30_sub1.anInt1296 == 0)
            i =
                    worldController.method300(
                            class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (class30_sub1.anInt1296 == 1)
            i =
                    worldController.method301(
                            class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (class30_sub1.anInt1296 == 2)
            i =
                    worldController.method302(
                            class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (class30_sub1.anInt1296 == 3)
            i =
                    worldController.method303(
                            class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (i != 0) {
            int i1 =
                    worldController.method304(
                            class30_sub1.anInt1295,
                            class30_sub1.anInt1297,
    ...
    private static final void initAudioSystem() {
        if (!audioInitialized) {
    ...
    void startUp() {
        ...
        initAudioSystem();
        if (signlink.sunjava) super.minDelay = 5;
        if (aBoolean993) {
        ...
        if (signlink.cache_dat != null) {
            for (int i = 0; i < 5; i++)
                decompressors[i] =
                        new Decompressor(signlink.cache_dat, signlink.cache_idx[i], i + 1);
        }
        try {
            connectServer();
            titleStreamLoader =
                    streamLoaderForName(1, "title screen", "title", expectedCRCs[1], 25);
            ...
            TextDrawingArea aTextDrawingArea_1273 =
                    new TextDrawingArea(true, "q8_full", titleStreamLoader);
            drawLogo();
            loadTitleScreen();
            StreamLoader streamLoader =
                    streamLoaderForName(2, "config", "config", expectedCRCs[2], 30);
            ...
            for (int i1 = 0; i1 < k; i1++) onDemandFetcher.method558(1, i1);

            while (onDemandFetcher.getNodeCount() > 0) {
                int j1 = k - onDemandFetcher.getNodeCount();
                if (j1 > 0) drawLoadingText(65, "Loading animations - " + (j1 * 100) / k + "%");
                processOnDemandQueue();
                try {
                    Thread.sleep(100L);
                } catch (Exception _ex) {
            ...
            for (int k1 = 0; k1 < k; k1++) {
                ...
                if ((l1 & 1) != 0) onDemandFetcher.method558(0, k1);
            }

            k = onDemandFetcher.getNodeCount();
            while (onDemandFetcher.getNodeCount() > 0) {
                int i2 = k - onDemandFetcher.getNodeCount();
                if (i2 > 0) drawLoadingText(70, "Loading models - " + (i2 * 100) / k + "%");
                processOnDemandQueue();
                try {
                    Thread.sleep(100L);
                } catch (Exception _ex) {
            ...
            if (decompressors[0] != null) {
                ...
                while (onDemandFetcher.getNodeCount() > 0) {
                    ...
                    if (j2 > 0) drawLoadingText(75, "Loading maps - " + (j2 * 100) / k + "%");
                    processOnDemandQueue();
                    try {
                        Thread.sleep(100L);
                    } catch (Exception _ex) {
            ...
            for (int k2 = 0; k2 < k; k2++) {
                ...
                byte byte0 = 0;
                if ((l2 & 8) != 0) byte0 = 10;
                else if ((l2 & 0x20) != 0) byte0 = 9;
                else if ((l2 & 0x10) != 0) byte0 = 8;
                else if ((l2 & 0x40) != 0) byte0 = 7;
                else if ((l2 & 0x80) != 0) byte0 = 6;
                else if ((l2 & 2) != 0) byte0 = 5;
                else if ((l2 & 4) != 0) byte0 = 4;
                if ((l2 & 1) != 0) byte0 = 3;
                if (byte0 != 0) onDemandFetcher.method563(byte0, 0, k2);
            }
    ...
    private void processMainScreenClick() {
        ...
        if (super.clickMode3 == 1) {
            ...
            if (anInt1117 > 1151) {
                ...
                if ((int) (Math.random() * 2D) == 0) stream.writeWordBigEndian(101);
                stream.writeWordBigEndian(197);
                stream.writeWord((int) (Math.random() * 65536D));
                stream.writeWordBigEndian((int) (Math.random() * 256D));
                stream.writeWordBigEndian(67);
                stream.writeWord(14214);
                if ((int) (Math.random() * 2D) == 0) stream.writeWord(29487);
                stream.writeWord((int) (Math.random() * 65536D));
                if ((int) (Math.random() * 2D) == 0) stream.writeWordBigEndian(220);
    ...
    private String interfaceIntToString(int j) {
        if (j < 0x3b9ac9ff) return String.valueOf(j);
        else return "*";
    }
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            k += 30;
            g.drawString(
                    "2: Try clearing your web-browsers cache from tools->internet options", 30, k);
            k += 30;
            ...
            k += 30;
            g.drawString(
                    "5: Try selecting a different version of Java from the play-game menu", 30, k);
        }
    ...
    public URL getCodeBase() {
        if (signlink.mainapp != null) return signlink.mainapp.getCodeBase();
        try {
            if (super.gameFrame != null) return new URL("http://" + server + ":" + (80 + portOff));
        } catch (Exception _ex) {
        }
    ...
    private void method96(Entity entity) {
        ...
        if (entity.anInt1547 > loopCycle) method97(entity);
        else if (entity.anInt1548 >= loopCycle) method98(entity);
    ...
    private void method98(Entity entity) {
        if (entity.anInt1548 == loopCycle
                ...
                || entity.anInt1529 != 0
                || entity.anInt1528 + 1
                        > Animation.anims[entity.anim].method258(entity.anInt1527)) {
    ...
    private void method99(Entity entity) {
        ...
        if (i < k) {
            if (j < l) entity.turnDirection = 1280;
            else if (j > l) entity.turnDirection = 1792;
            else entity.turnDirection = 1536;
        } else if (i > k) {
            if (j < l) entity.turnDirection = 768;
            else if (j > l) entity.turnDirection = 256;
            else entity.turnDirection = 512;
        } else if (j < l) entity.turnDirection = 1024;
        else entity.turnDirection = 0;
        int i1 = entity.turnDirection - entity.anInt1552 & 0x7ff;
        if (i1 > 1024) i1 -= 2048;
        int j1 = entity.anInt1555;
        if (i1 >= -256 && i1 <= 256) j1 = entity.anInt1554;
        else if (i1 >= 256 && i1 < 768) j1 = entity.anInt1557;
        else if (i1 >= -768 && i1 <= -256) j1 = entity.anInt1556;
        if (j1 == -1) j1 = entity.anInt1554;
        entity.anInt1517 = j1;
        int k1 = 4;
        if (entity.anInt1552 != entity.turnDirection
                && entity.interactingEntity == -1
                && entity.anInt1504 != 0) k1 = 2;
    ...
    private void method100(Entity entity) {
        ...
        if (l != 0) {
            if (l < entity.anInt1504 || l > 2048 - entity.anInt1504)
                entity.anInt1552 = entity.turnDirection;
            else if (l > 1024) entity.anInt1552 -= entity.anInt1504;
            else entity.anInt1552 += entity.anInt1504;
    ...
    private void method101(Entity entity) {
        ...
        if (entity.anInt1520 != -1 && loopCycle >= entity.anInt1523) {
            ...
            for (entity.anInt1522++;
                    ...
                    entity.anInt1521++) entity.anInt1522 -= animation_1.method258(entity.anInt1521);
        ...
        if (entity.anim != -1 && entity.anInt1529 == 0) {
            ...
            for (entity.anInt1528++;
                    entity.anInt1527 < animation_3.anInt352
                            && entity.anInt1528 > animation_3.method258(entity.anInt1527);
                    entity.anInt1527++) entity.anInt1528 -= animation_3.method258(entity.anInt1527);
    ...
    private void drawGameScreen() {
        ...
        if (backDialogID == -1) {
            ...
            if (i < 0) i = 0;
            if (i > anInt1211 - 77) i = anInt1211 - 77;
            if (anInt1089 != i) {
                anInt1089 = i;
                inputTaken = true;
            }
        ...
        if (aBoolean1233) {
            ...
            if (publicChatMode == 0) aTextDrawingArea_1271.method382(65280, 55, "On", 41, true);
            if (publicChatMode == 1)
                aTextDrawingArea_1271.method382(0xffff00, 55, "Friends", 41, true);
            if (publicChatMode == 2) aTextDrawingArea_1271.method382(0xff0000, 55, "Off", 41, true);
            if (publicChatMode == 3) aTextDrawingArea_1271.method382(65535, 55, "Hide", 41, true);
            aTextDrawingArea_1271.method382(0xffffff, 184, "Private chat", 28, true);
            if (privateChatMode == 0) aTextDrawingArea_1271.method382(65280, 184, "On", 41, true);
            ...
            if (tradeMode == 0) aTextDrawingArea_1271.method382(65280, 324, "On", 41, true);
            if (tradeMode == 1) aTextDrawingArea_1271.method382(0xffff00, 324, "Friends", 41, true);
            if (tradeMode == 2) aTextDrawingArea_1271.method382(0xff0000, 324, "Off", 41, true);
    ...
    private void method104() {
        ...
        for (;
                ...
                class30_sub2_sub4_sub3 = (Animable_Sub3) aClass19_1056.reverseGetNext())
            if (class30_sub2_sub4_sub3.anInt1560 != plane || class30_sub2_sub4_sub3.aBoolean1567)
                ...
                if (class30_sub2_sub4_sub3.aBoolean1567) class30_sub2_sub4_sub3.unlink();
                else
                    worldController.method285(
                            class30_sub2_sub4_sub3.anInt1560,
                            0,
    ...
    private void drawInterface(int j, int k, RSInterface class9, int l) {
        if (class9.type != 0 || class9.children == null) return;
        if (class9.aBoolean266
                && anInt1026 != class9.id
                && anInt1048 != class9.id
                && anInt1039 != class9.id) return;
        ...
        for (int j2 = 0; j2 < i2; j2++) {
            ...
            if (class9_1.anInt214 > 0) drawFriendsListOrWelcomeScreen(class9_1);
            if (class9_1.type == 0) {
                ...
                if (class9_1.type == 2) {
                        ...
                        for (int l4 = 0; l4 < class9_1.width; l4++) {
                            ...
                            if (class9_1.inv[i3] > 0) {
                                ...
                                if (k5 > DrawingArea.topX - 32
                                    ...
                                    if (itemSelected == 1
                                            && anInt1283 == i3
                                            && anInt1284 == class9_1.id) l9 = 0xffffff;
                                    Sprite class30_sub2_sub1_sub1_2 =
                                            ItemDef.getSprite(j9, class9_1.invStackSizes[i3], l9);
                                    if (class30_sub2_sub1_sub1_2 != null) {
                                        if (activeInterfaceType != 0
                                            ...
                                            if (j6 + j7 < DrawingArea.topY
                                                ...
                                                int i10 =
                                                        (anInt945 * (DrawingArea.topY - j6 - j7))
                                                                / 3;
                                        ...
                                        if (class30_sub2_sub1_sub1_2.anInt1444 == 33
                                            ...
                                            aTextDrawingArea_1270.method385(
                                                    0, intToKOrMil(k10), j6 + 10 + j7, k5 + 1 + k6);
                                            aTextDrawingArea_1270.method385(
                                                    0xffff00,
                                                    intToKOrMil(k10),
                                                    j6 + 9 + j7,
                    ...
                    if (anInt1039 == class9_1.id
                            ...
                            || anInt1026 == class9_1.id) flag = true;
                    int j3;
                    if (interfaceIsSelected(class9_1)) {
                        j3 = class9_1.anInt219;
                        if (flag && class9_1.anInt239 != 0) j3 = class9_1.anInt239;
                    } else {
                        j3 = class9_1.textColor;
                        if (flag && class9_1.anInt216 != 0) j3 = class9_1.anInt216;
                    }
                    if (class9_1.aByte254 == 0) {
                        ...
                        DrawingArea.method335(
                                j3,
                                l2,
                                class9_1.width,
                                class9_1.height,
                                256 - (class9_1.aByte254 & 0xff),
                                k2);
                    else
                        DrawingArea.method338(
                                l2,
                                class9_1.height,
                                256 - (class9_1.aByte254 & 0xff),
                                j3,
                    ...
                    if (anInt1039 == class9_1.id
                            || anInt1048 == class9_1.id
                            || anInt1026 == class9_1.id) flag1 = true;
                    int i4;
                    if (interfaceIsSelected(class9_1)) {
                        i4 = class9_1.anInt219;
                        if (flag1 && class9_1.anInt239 != 0) i4 = class9_1.anInt239;
                        if (class9_1.aString228.length() > 0) s = class9_1.aString228;
                    } else {
                        i4 = class9_1.textColor;
                        if (flag1 && class9_1.anInt216 != 0) i4 = class9_1.anInt216;
                    }
                    ...
                    for (int l6 = l2 + textDrawingArea.anInt1497;
                            s.length() > 0;
                            l6 += textDrawingArea.anInt1497) {
                        if (s.indexOf("%") != -1) {
                            do {
                                int k7 = s.indexOf("%1");
                                if (k7 == -1) break;
                                s =
                                        s.substring(0, k7)
                                                + interfaceIntToString(
                                                        extractInterfaceValues(class9_1, 0))
                                                + s.substring(k7 + 2);
                            } while (true);
                            do {
                                int l7 = s.indexOf("%2");
                                ...
                                s =
                                        s.substring(0, l7)
                                                + interfaceIntToString(
                                                        extractInterfaceValues(class9_1, 1))
                                                + s.substring(l7 + 2);
                            } while (true);
                            do {
                                int i8 = s.indexOf("%3");
                                ...
                                s =
                                        s.substring(0, i8)
                                                + interfaceIntToString(
                                                        extractInterfaceValues(class9_1, 2))
                                                + s.substring(i8 + 2);
                            } while (true);
                            do {
                                int j8 = s.indexOf("%4");
                                ...
                                s =
                                        s.substring(0, j8)
                                                + interfaceIntToString(
                                                        extractInterfaceValues(class9_1, 3))
                                                + s.substring(j8 + 2);
                            } while (true);
                            do {
                                int k8 = s.indexOf("%5");
                                ...
                                s =
                                        s.substring(0, k8)
                                                + interfaceIntToString(
                                                        extractInterfaceValues(class9_1, 4))
                                                + s.substring(k8 + 2);
                            } while (true);
                        }
                        int l8 = s.indexOf("\\n");
                        ...
                        if (class9_1.aBoolean223)
                            textDrawingArea.method382(
                                    i4, k2 + class9_1.width / 2, s1, l6, class9_1.aBoolean268);
                        else textDrawingArea.method389(class9_1.aBoolean268, k2, i4, s1, l6);
                    }

                } else if (class9_1.type == 5) {
                    Sprite sprite;
                    if (interfaceIsSelected(class9_1)) sprite = class9_1.sprite2;
                    else sprite = class9_1.sprite1;
                    if (sprite != null) sprite.drawSprite(k2, l2);
                    ...
                    int i7;
                    if (flag2) i7 = class9_1.anInt258;
                    else i7 = class9_1.anInt257;
                    Model model;
                    if (i7 == -1) {
                            ...
                            if (class9_1.inv[k4] > 0) {
                                ...
                                if (class9_1.aBoolean223)
                                    ...
                                    textDrawingArea_1.method389(
                                            class9_1.aBoolean268, i9, class9_1.textColor, s2, k9);
                            }
                            k4++;
                        }
                    }
    ...
    private void method107(int i, int j, Stream stream, Player player) {
        ...
        if ((i & 4) != 0) {
            ...
            } else if (player == myPlayer) pushMessage(player.textSpoken, 2, player.name);
            player.anInt1513 = 0;
            player.anInt1531 = 0;
            ...
            if (player.name != null && player.visible) {
                ...
                if (!flag && anInt1251 == 0)
                    try {
                        ...
                        player.textCycle = 150;
                        if (j2 == 2 || j2 == 3) pushMessage(s, 1, "@cr2@" + player.name);
                        else if (j2 == 1) pushMessage(s, 1, "@cr1@" + player.name);
                        else pushMessage(s, 2, player.name);
                    } catch (Exception exception) {
    ...
    private void method108() {
        try {
            ...
            if (super.keyArray[1] == 1) anInt1186 += (-24 - anInt1186) / 2;
            else if (super.keyArray[2] == 1) anInt1186 += (24 - anInt1186) / 2;
            else anInt1186 /= 2;
            if (super.keyArray[3] == 1) anInt1187 += (12 - anInt1187) / 2;
            else if (super.keyArray[4] == 1) anInt1187 += (-12 - anInt1187) / 2;
            else anInt1187 /= 2;
            ...
            if (anInt1005 > 1512) {
                ...
                if ((int) (Math.random() * 2D) == 0) stream.writeWord(35784);
                stream.writeWordBigEndian((int) (Math.random() * 256D));
    ...
    public void processDrawing() {
        ...
        anInt1061++;
        if (!loggedIn) drawLoginScreen(false);
        else drawGameScreen();
        anInt1213 = 0;
    }
    ...
    private void draw3dScreen() {
        ...
        if (anInt1104 != 0) {
            ...
            j %= 60;
            if (j < 10)
                aTextDrawingArea_1271.method385(
                        0xffff00, "System update in: " + l + ":0" + j, 329, 4);
            else
                aTextDrawingArea_1271.method385(
                        0xffff00, "System update in: " + l + ":" + j, 329, 4);
            anInt849++;
            if (anInt849 > 75) {
                anInt849 = 0;
            ...
            for (Class30_Sub1 class30_sub1 = (Class30_Sub1) aClass19_1179.reverseGetFirst();
                ...
                if (class30_sub1.anInt1294 == 0) {
                    if (class30_sub1.anInt1299 < 0
                            || ObjectManager.method178(
                                    class30_sub1.anInt1299, class30_sub1.anInt1301)) {
                        method142(
                                class30_sub1.anInt1298,
                                class30_sub1.anInt1295,
                                class30_sub1.anInt1300,
                                class30_sub1.anInt1301,
                                class30_sub1.anInt1297,
                                class30_sub1.anInt1296,
                    ...
                    if (class30_sub1.anInt1302 == 0
                            ...
                            && (class30_sub1.anInt1291 < 0
                                    || ObjectManager.method178(
                                            class30_sub1.anInt1291, class30_sub1.anInt1293))) {
                        method142(
                                class30_sub1.anInt1298,
                                class30_sub1.anInt1295,
                                class30_sub1.anInt1292,
                        ...
                        if (class30_sub1.anInt1291 == class30_sub1.anInt1299
                                && class30_sub1.anInt1299 == -1) class30_sub1.unlink();
    ...
    private void determineMenuSize() {
        ...
        if (super.saveClickX > 4
            ...
            if (i1 + i > 512) i1 = 512 - i;
            if (i1 < 0) i1 = 0;
            int l1 = super.saveClickY - 4;
            if (l1 + l > 334) l1 = 334 - l;
            if (l1 < 0) l1 = 0;
            menuOpen = true;
            menuScreenArea = 0;
            menuOffsetX = i1;
        ...
        if (super.saveClickX > 553
            ...
            if (j1 < 0) j1 = 0;
            else if (j1 + i > 190) j1 = 190 - i;
            int i2 = super.saveClickY - 205;
            if (i2 < 0) i2 = 0;
            else if (i2 + l > 261) i2 = 261 - l;
            menuOpen = true;
            menuScreenArea = 1;
            menuOffsetX = j1;
            menuOffsetY = i2;
        ...
        if (super.saveClickX > 17
            ...
            if (k1 < 0) k1 = 0;
            else if (k1 + i > 479) k1 = 479 - i;
            int j2 = super.saveClickY - 357;
            if (j2 < 0) j2 = 0;
            else if (j2 + l > 96) j2 = 96 - l;
            menuOpen = true;
            menuScreenArea = 2;
            menuOffsetX = k1;
            menuOffsetY = j2;
    ...
    private boolean method119(int i, int j) {
        ...
        for (int k = 0; k < class9.children.length; k++) {
            ...
            if (class9_1.type == 6 && (class9_1.anInt257 != -1 || class9_1.anInt258 != -1)) {
                boolean flag2 = interfaceIsSelected(class9_1);
                int l;
                if (flag2) l = class9_1.anInt258;
                else l = class9_1.anInt257;
                if (l != -1) {
                    Animation animation = Animation.anims[l];
                    for (class9_1.anInt208 += i;
        ...
        try {
            ...
            for (int j = 0; j < ignoreCount; j++)
                if (ignoreListAsLongs[j] == l) {
                    ...
                    needDrawTabArea = true;
                    System.arraycopy(
                            ignoreListAsLongs, j + 1, ignoreListAsLongs, j, ignoreCount - j);
    ...
    public String getParameter(String s) {
        if (signlink.mainapp != null) return signlink.mainapp.getParameter(s);
    ...
    private void drawMinimap() {
        ...
        if (anInt1021 == 2) {
            ...
            compass.method352(
                    33, minimapInt1, anIntArray1057, 256, anIntArray968, 25, 0, 0, 33, 25);
            aRSImageProducer_1165.initDrawingArea();
            return;
        }
        ...
        aClass30_Sub2_Sub1_Sub1_1263.method352(
                151, i, anIntArray1229, 256 + minimapInt3, anIntArray1052, l2, 5, 25, 146, j);
        ...
        for (int j6 = 0; j6 < playerCount; j6++) {
            ...
            if (player != null && player.isVisible()) {
                ...
                if (myPlayer.team != 0 && player.team != 0 && myPlayer.team == player.team)
                    flag2 = true;
                if (flag1) markMinimap(mapDotFriend, j1, l3);
                else if (flag2) markMinimap(mapDotTeam, j1, l3);
            ...
            if (chatMessages[j] != null) {
                ...
                if ((k == 3 || k == 7)
                    ...
                    if (super.mouseX > 4
                            ...
                            && super.mouseY - 4 <= l + 3) {
                        int i1 =
                                aTextDrawingArea_1271.getTextWidth("From:  " + s + chatMessages[j])
                                        + 25;
                        if (i1 > 450) i1 = 450;
    ...
    private void method130(int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2) {
        ...
        for (Class30_Sub1 class30_sub1_1 = (Class30_Sub1) aClass19_1179.reverseGetFirst();
            ...
            if (class30_sub1_1.anInt1295 != l1
                    ...
                    || class30_sub1_1.anInt1296 != i1) continue;
    ...
    private void doFlamesDrawing() {
        ...
        if (anInt1040 > 0) {
            for (int i = 0; i < 256; i++)
                if (anInt1040 > 768)
                    anIntArray850[i] =
                            method83(anIntArray851[i], anIntArray852[i], 1024 - anInt1040);
                else if (anInt1040 > 256) anIntArray850[i] = anIntArray852[i];
                else
                    anIntArray850[i] =
                            method83(anIntArray852[i], anIntArray851[i], 256 - anInt1040);

        } else if (anInt1041 > 0) {
            for (int j = 0; j < 256; j++)
                if (anInt1041 > 768)
                    anIntArray850[j] =
                            method83(anIntArray851[j], anIntArray853[j], 1024 - anInt1041);
                else if (anInt1041 > 256) anIntArray850[j] = anIntArray853[j];
                else
                    anIntArray850[j] =
                            method83(anIntArray853[j], anIntArray851[j], 256 - anInt1041);
        ...
        for (int k1 = 1; k1 < c - 1; k1++) {
            ...
            for (int l2 = j2; l2 < 128; l2++) {
                ...
                if (j3 != 0) {
                    ...
                    aRSImageProducer_1110.anIntArray315[j1++] =
        ...
        for (int k2 = 1; k2 < c - 1; k2++) {
            ...
            for (int i4 = 0; i4 < k3; i4++) {
                ...
                if (k4 != 0) {
                    ...
                    aRSImageProducer_1111.anIntArray315[j1++] =
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 3) {
            chatTextDrawingArea.method382(
                    0xffff00, c / 2, "Create a free account", c1 / 2 - 60, true);
            int k = c1 / 2 - 35;
            chatTextDrawingArea.method382(
                    0xffffff, c / 2, "To create a new account you need to", k, true);
            k += 15;
            chatTextDrawingArea.method382(
                    0xffffff, c / 2, "go back to the main RuneScape webpage", k, true);
            k += 15;
            chatTextDrawingArea.method382(
                    0xffffff, c / 2, "and choose the red 'create account'", k, true);
            k += 15;
            chatTextDrawingArea.method382(
                    0xffffff, c / 2, "button at the top right of that page.", k, true);
            k += 15;
            int j1 = c / 2;
            int i2 = c1 / 2 + 50;
    ...
    private void method137(Stream stream, int j) {
        if (j == 84) {
            ...
            if (j3 >= 0 && i6 >= 0 && j3 < 104 && i6 < 104) {
                ...
                if (class19_1 != null) {
                    for (Item class30_sub2_sub4_sub2_3 = (Item) class19_1.reverseGetFirst();
                            class30_sub2_sub4_sub2_3 != null;
                            class30_sub2_sub4_sub2_3 = (Item) class19_1.reverseGetNext()) {
                        if (class30_sub2_sub4_sub2_3.ID != (l8 & 0x7fff)
                                || class30_sub2_sub4_sub2_3.anInt1559 != k11) continue;
            ...
            if (j4 >= 0 && i7 >= 0 && j4 < 103 && i7 < 103) {
                ...
                if (j16 == 0) {
                    ...
                    if (class10 != null) {
                        ...
                        if (j12 == 2) {
                            class10.aClass30_Sub2_Sub4_278 =
                                    new Animable_Sub5(
                                            k21, 4 + k14, 2, i19, l19, j18, k20, j17, false);
                            class10.aClass30_Sub2_Sub4_279 =
                                    new Animable_Sub5(
                                            k21, k14 + 1 & 3, 2, i19, l19, j18, k20, j17, false);
                        } else {
                            class10.aClass30_Sub2_Sub4_278 =
                                    new Animable_Sub5(
                                            k21, k14, j12, i19, l19, j18, k20, j17, false);
                        }
                    }
                }
                if (j16 == 1) {
        ...
        if (j == 147) {
            ...
            Player player;
            if (i10 == unknownInt10) player = myPlayer;
            else player = playerArray[i10];
            if (player != null) {
        ...
        if (j == 4) {
            ...
            if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
                i5 = i5 * 128 + 64;
                l7 = l7 * 128 + 64;
                Animable_Sub3 class30_sub2_sub4_sub3 =
                        new Animable_Sub3(
                                plane, loopCycle, j15, k10, method42(plane, l7, i5) - l12, l7, i5);
        ...
        if (j == 117) {
            ...
            if (l5 >= 0
                ...
                j11 = j11 * 128 + 64;
                k13 = k13 * 128 + 64;
                Animable_Sub4 class30_sub2_sub4_sub4 =
                        new Animable_Sub4(
                                i21,
                                l18,
                                k19 + loopCycle,
                                ...
                                j21,
                                plane,
                                method42(plane, k8, l5) - i18,
                                k8,
                                l5,
                                l15,
                                i17);
                class30_sub2_sub4_sub4.method455(
                        k19 + loopCycle, k13, method42(plane, k13, j11) - l18, j11);
        ...
        if (loginScreenState == 0) {
            ...
            if (loginScreenState == 3) {
                ...
                if (super.clickMode3 == 1
                        ...
                        && super.saveClickY <= j1 + 20) loginScreenState = 0;
            }
        }
    }
    ...
    private void markMinimap(Sprite sprite, int i, int j) {
        ...
        if (l > 2500) {
            ...
            sprite.drawSprite(
                    ((94 + k1) - sprite.anInt1444 / 2) + 4, 83 - l1 - sprite.anInt1445 / 2 - 4);
        }
    }
    ...
    private void method142(int i, int j, int k, int l, int i1, int j1, int k1) {
        if (i1 >= 1 && i >= 1 && i1 <= 102 && i <= 102) {
            ...
            int i2 = 0;
            if (j1 == 0) i2 = worldController.method300(j, i1, i);
            if (j1 == 1) i2 = worldController.method301(j, i1, i);
            if (j1 == 2) i2 = worldController.method302(j, i1, i);
            if (j1 == 3) i2 = worldController.method303(j, i1, i);
            if (i2 != 0) {
                ...
                if (j1 == 2) {
                    ...
                    if (i1 + class46_1.anInt744 > 103
                            ...
                            || i + class46_1.anInt761 > 103) return;
                    if (class46_1.aBoolean767)
                        aClass11Array1230[j].method216(
                                l2,
                                class46_1.anInt744,
                                i1,
                                i,
    ...
    private void updatePlayers(int i, Stream stream) {
        ...
        if (stream.currentOffset != i) {
            signlink.reporterror(
                    "Error packet size mismatch in getplayer pos:"
                            + stream.currentOffset
                            + " psize:"
                            + i);
            throw new RuntimeException("eek");
        ...
        try {
            ...
            if (pktType == 185) {
                ...
                if (myPlayer.desc == null)
                    ...
                    RSInterface.interfaceCache[k].mediaID =
                            (int) (0x12345678L + myPlayer.desc.type);
                pktType = -1;
                return true;
            }
            if (pktType == 107) {
                    ...
                    for (int l23 = (anInt1069 - 6) / 8; l23 <= (anInt1069 + 6) / 8; l23++) {
                        for (int j26 = (anInt1070 - 6) / 8; j26 <= (anInt1070 + 6) / 8; j26++) {
                            ...
                            if (aBoolean1141
                                ...
                                int k28 =
                                        anIntArray1235[k16] =
                                                onDemandFetcher.method562(0, j26, l23);
                                if (k28 != -1) onDemandFetcher.method558(3, k28);
                                int j30 =
                                        anIntArray1236[k16] =
                                                onDemandFetcher.method562(1, j26, l23);
            ...
            if (pktType == 254) {
                ...
                if (anInt855 == 1) anInt1222 = inStream.readUnsignedWord();
            ...
            if (pktType == 196) {
                ...
                if (!flag5 && anInt1251 == 0)
                    try {
                        ...
                        if (l21 == 2 || l21 == 3)
                            pushMessage(
                                    s9, 7, "@cr2@" + TextClass.fixName(TextClass.nameForLong(l5)));
                        else if (l21 == 1)
                            pushMessage(
                                    s9, 7, "@cr1@" + TextClass.fixName(TextClass.nameForLong(l5)));
            ...
            signlink.reporterror(
                    "T1 - " + pktType + "," + pktSize + " - " + anInt842 + "," + anInt843);
            resetLogout();
        } catch (IOException _ex) {
            dropClient();
        } catch (Exception exception) {
    ...
    private void method146() {
        ...
        for (int i2 = 0; i2 < 5; i2++)
            if (aBooleanArray876[i2]) {
                int j2 =
                        (int)
                                ((Math.random() * (double) (anIntArray873[i2] * 2 + 1)
                                                - (double) anIntArray873[i2])
                                        + Math.sin(
                                                        (double) anIntArray1030[i2]
                                                                * ((double) anIntArray928[i2]
                                                                        / 100D))
