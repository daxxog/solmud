...
final class Class13 {
    ...
    private static void method226(Class32 class32) {
        ...
        if (class32.anInt571 < i2) class32.anInt572++;
    ...
    private static void method227(Class32 class32) {
        ...
        while (flag19) {
            ...
            if (class32.aBoolean575) System.out.println("PANIC! RANDOMISED BLOCK!");
            class32.anInt580 = 0;
            byte0 = method228(class32);
            ...
            for (int k = 0; k < 256; k++) class32.aBooleanArray589[k] = false;

            for (int l = 0; l < 16; l++)
                if (class32.aBooleanArray590[l]) {
                    for (int i3 = 0; i3 < 16; i3++) {
                        byte byte2 = method229(class32);
                        if (byte2 == 1) class32.aBooleanArray589[l * 16 + i3] = true;
                    }
                }
            ...
            for (int l3 = 0; l3 < j4; l3++) {
                ...
                method232(
                        class32.anIntArrayArray597[l3],
                        class32.anIntArrayArray598[l3],
                        class32.anIntArrayArray599[l3],
                        class32.aByteArrayArray596[l3],
                        byte8,
                        i,
                        i4);
            ...
            int i5 = -1;
            int j5 = 0;
            for (int i2 = 0; i2 <= 255; i2++) class32.anIntArray583[i2] = 0;
            ...
            for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; )
                if (k5 == 0 || k5 == 1) {
                    ...
                    j6++;
                    byte byte5 =
                            class32.aByteArray591[
                                    class32.aByteArray592[class32.anIntArray593[0]] & 0xff];
                    ...
                    if (j11 < 16) {
                        ...
                        for (; j11 > 0; j11--)
                            class32.aByteArray592[j10 + j11] =
                                    class32.aByteArray592[(j10 + j11) - 1];
                        ...
                        for (; l10 > 0; l10--) {
                            class32.anIntArray593[l10]--;
                            class32.aByteArray592[class32.anIntArray593[l10]] =
                                    class32.aByteArray592[
                                            (class32.anIntArray593[l10 - 1] + 16) - 1];
                        }
                        ...
                        if (class32.anIntArray593[0] == 0) {
                            ...
                            for (int k9 = 15; k9 >= 0; k9--) {
                                for (int l9 = 15; l9 >= 0; l9--) {
                                    class32.aByteArray592[i10] =
                                            class32.aByteArray592[class32.anIntArray593[k9] + l9];
                                    i10--;
                                }
    ...
    private static int method230(int i, Class32 class32) {
        ...
        do {
            ...
            class32.anInt576 =
                    class32.anInt576 << 8 | class32.aByteArray563[class32.anInt564] & 0xff;
            class32.anInt577 += 8;
            class32.anInt564++;
            class32.anInt565--;
            class32.anInt566++;
            if (class32.anInt566 == 0) class32.anInt567++;
        } while (true);
        return j;
    }
