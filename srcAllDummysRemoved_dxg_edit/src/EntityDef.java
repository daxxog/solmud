...
public final class EntityDef {
    ...
    public static EntityDef forID(int i) {
        for (int j = 0; j < 20; j++) if (cache[j].type == (long) i) return cache[j];
    ...
    public Model method164(int j, int k, int ai[]) {
        ...
        if (anInt91 != 128 || anInt86 != 128) model_1.method478(anInt91, anInt91, anInt86);
        model_1.method466();
    ...
    private void readValues(Stream stream) {
        do {
            ...
            else if (i == 13) anInt77 = stream.readUnsignedWord();
            else if (i == 14) anInt67 = stream.readUnsignedWord();
            else if (i == 17) {
            ...
            else if (i == 95) combatLevel = stream.readUnsignedWord();
