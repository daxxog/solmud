...
final class Sounds {
    ...
    private int method243() {
        ...
        if (anInt330 < anInt331 && anInt330 / 20 < j) j = anInt330 / 20;
        if (j == 0x98967f || j == 0) return 0;
        for (int l = 0; l < 10; l++)
            if (aClass6Array329[l] != null) aClass6Array329[l].anInt114 -= j * 20;
    ...
    private int method245(int i) {
        ...
        for (int k = 0; k < 10; k++)
            if (aClass6Array329[k] != null
                    && aClass6Array329[k].anInt113 + aClass6Array329[k].anInt114 > j)
        ...
        if (i1 < 0 || i1 > l || j1 < 0 || j1 > l || i1 >= j1) i = 0;
        int k1 = l + (j1 - i1) * (i - 1);
        for (int l1 = 44; l1 < k1 + 44; l1++) aByteArray327[l1] = -128;
        ...
        for (int i2 = 0; i2 < 10; i2++)
            if (aClass6Array329[i2] != null) {
                ...
                for (int l3 = 0; l3 < j2; l3++) aByteArray327[l3 + i3 + 44] += (byte) (ai[l3] >> 8);
            }
        ...
        if (i > 1) {
            ...
            l += 44;
            int k2 = (k1 += 44) - l;
            for (int j3 = l - 1; j3 >= j1; j3--) aByteArray327[j3 + k2] = aByteArray327[j3];
