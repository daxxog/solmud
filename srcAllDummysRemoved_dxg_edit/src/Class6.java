...
final class Class6 {
    ...
    public static void method166() {
        ...
        for (int i = 0; i < 32768; i++)
            if (Math.random() > 0.5D) anIntArray116[i] = 1;
            else anIntArray116[i] = -1;
    ...
    public int[] method167(int i, int j) {
        for (int k = 0; k < i; k++) anIntArray115[k] = 0;

        if (j < 10) return anIntArray115;
        ...
        if (aClass29_100 != null) {
            ...
            l =
                    (int)
                            (((double) (aClass29_100.anInt539 - aClass29_100.anInt538)
                                            * 32.768000000000001D)
                                    / d);
        ...
        if (aClass29_102 != null) {
            ...
            k1 =
                    (int)
                            (((double) (aClass29_102.anInt539 - aClass29_102.anInt538)
                                            * 32.768000000000001D)
                                    / d);
        ...
        for (int j2 = 0; j2 < 5; j2++)
            if (anIntArray106[j2] != 0) {
                ...
                anIntArray121[j2] =
                        (int)
                                (((double) (aClass29_98.anInt539 - aClass29_98.anInt538)
                                                * 32.768000000000001D
                                                * Math.pow(1.0057929410678534D, anIntArray107[j2]))
                                        / d);
                anIntArray122[j2] =
                        (int) (((double) aClass29_98.anInt538 * 32.768000000000001D) / d);
            }
        ...
        if (aClass29_104 != null) {
            ...
            for (int i7 = 0; i7 < i; i7++) {
                ...
                if (flag1)
                    k4 =
                            aClass29_104.anInt538
                                    + ((aClass29_104.anInt539 - aClass29_104.anInt538) * k7 >> 8);
                else
                    k4 =
                            aClass29_104.anInt538
                                    + ((aClass29_104.anInt539 - aClass29_104.anInt538) * i8 >> 8);
                if ((i3 += 256) >= k4) {
                    i3 = 0;
                    flag1 = !flag1;
                }
                if (flag1) anIntArray115[i7] = 0;
            }
        }
            ...
            if (i >= i5 + i6) {
                ...
                for (; j7 < l7; j7++) {
                    ...
                    for (int k8 = 0; k8 < i5; k8++)
                        j8 +=
                                (int)
                                        ((long) anIntArray115[(j7 + i5) - 1 - k8]
                                                        * (long) Class39.anIntArrayArray670[0][k8]
                                                >> 16);

                    for (int j9 = 0; j9 < j7; j9++)
                        j8 -=
                                (int)
                                        ((long) anIntArray115[j7 - 1 - j9]
                                                        * (long) Class39.anIntArrayArray670[1][j9]
                                                >> 16);
                ...
                do {
                    ...
                    for (; j7 < l7; j7++) {
                        int l8 =
                                (int)
                                        ((long) anIntArray115[j7 + i5] * (long) Class39.anInt672
                                                >> 16);
                        for (int k9 = 0; k9 < i5; k9++)
                            l8 +=
                                    (int)
                                            ((long) anIntArray115[(j7 + i5) - 1 - k9]
                                                            * (long)
                                                                    Class39.anIntArrayArray670[0][
                                                                            k9]
                                                    >> 16);
                        ...
                        for (int i10 = 0; i10 < i6; i10++)
                            l8 -=
                                    (int)
                                            ((long) anIntArray115[j7 - 1 - i10]
                                                            * (long)
                                                                    Class39.anIntArrayArray670[1][
                                                                            i10]
                                                    >> 16);
                ...
                for (; j7 < i; j7++) {
                    ...
                    for (int l9 = (j7 + i5) - i; l9 < i5; l9++)
                        i9 +=
                                (int)
                                        ((long) anIntArray115[(j7 + i5) - 1 - l9]
                                                        * (long) Class39.anIntArrayArray670[0][l9]
                                                >> 16);

                    for (int j10 = 0; j10 < i6; j10++)
                        i9 -=
                                (int)
                                        ((long) anIntArray115[j7 - 1 - j10]
                                                        * (long) Class39.anIntArrayArray670[1][j10]
                                                >> 16);
        ...
        for (int i4 = 0; i4 < i; i4++) {
            if (anIntArray115[i4] < -32768) anIntArray115[i4] = -32768;
            if (anIntArray115[i4] > 32767) anIntArray115[i4] = 32767;
        }
    ...
    private int method168(int i, int k, int l) {
        if (l == 1)
            if ((k & 0x7fff) < 16384) return i;
            else return -i;
        if (l == 2) return anIntArray117[k & 0x7fff] * i >> 14;
        if (l == 3) return ((k & 0x7fff) * i >> 14) - i;
        if (l == 4) return anIntArray116[k / 2607 & 0x7fff] * i;
        else return 0;
    }
