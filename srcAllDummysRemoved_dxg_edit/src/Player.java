...
public final class Player extends Entity {
    ...
    public Model getRotatedModel() {
        ...
        if (super.anInt1520 != -1 && super.anInt1521 != -1) {
            ...
            if (model_2 != null) {
                ...
                model_3.method479(
                        64 + spotAnim.anInt413, 850 + spotAnim.anInt414, -30, -50, -30, true);
    ...
    public void updatePlayer(Stream stream) {
        ...
        if (super.anInt1511 == 65535) super.anInt1511 = -1;
    ...
    private Model method452() {
        ...
        if (model_1 == null) {
            ...
            for (int j3 = 0; j3 < 5; j3++)
                if (anIntArray1700[j3] != 0) {
                    model_1.method476(
                            client.anIntArrayArray1003[j3][0],
                            client.anIntArrayArray1003[j3][anIntArray1700[j3]]);
                    if (j3 == 1)
                        model_1.method476(
                                client.anIntArray1204[0],
        ...
        else if (k != -1) model_2.method470(k);
        model_2.method466();
    ...
    public Model method453() {
        ...
        for (int j1 = 0; j1 < 5; j1++)
            if (anIntArray1700[j1] != 0) {
                model.method476(
                        client.anIntArrayArray1003[j1][0],
                        client.anIntArrayArray1003[j1][anIntArray1700[j1]]);
                if (j1 == 1)
                    model.method476(
                            client.anIntArray1204[0], client.anIntArray1204[anIntArray1700[j1]]);
            }
