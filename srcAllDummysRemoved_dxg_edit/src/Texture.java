...
final class Texture extends DrawingArea {
    ...
    public static void method368(StreamLoader streamLoader) {
        ...
        for (int j = 0; j < 50; j++)
            try {
                ...
                else aBackgroundArray1474s[j].method357();
                anInt1473++;
            } catch (Exception _ex) {
            }
    }
    ...
    private static int[] method371(int i) {
        ...
        if (lowMem) {
            ...
            for (int i1 = 0; i1 < 4096; i1++) {
                ...
                if (i2 == 0) aBooleanArray1475[i] = true;
            ...
            if (background.anInt1452 == 64) {
                ...
                for (int k1 = 0; k1 < 16384; k1++) ai[k1] = ai1[background.aByteArray1450[k1]];
            }
            aBooleanArray1475[i] = false;
            for (int l1 = 0; l1 < 16384; l1++) {
                ai[l1] &= 0xf8f8ff;
                int k2 = ai[l1];
                if (k2 == 0) aBooleanArray1475[i] = true;
    ...
    public static void method372(double d) {
        ...
        for (int k = 0; k < 512; k++) {
            ...
            for (int k1 = 0; k1 < 128; k1++) {
                ...
                if (d2 != 0.0D) {
                    ...
                    if (d11 < 0.0D) d11++;
                    if (6D * d9 < 1.0D) d4 = d8 + (d7 - d8) * 6D * d9;
                    else if (2D * d9 < 1.0D) d4 = d7;
                    else if (3D * d9 < 2D) d4 = d8 + (d7 - d8) * (0.66666666666666663D - d9) * 6D;
                    else d4 = d8;
                    if (6D * d10 < 1.0D) d5 = d8 + (d7 - d8) * 6D * d10;
                    else if (2D * d10 < 1.0D) d5 = d7;
                    else if (3D * d10 < 2D) d5 = d8 + (d7 - d8) * (0.66666666666666663D - d10) * 6D;
                    else d5 = d8;
                    if (6D * d11 < 1.0D) d6 = d8 + (d7 - d8) * 6D * d11;
                    else if (2D * d11 < 1.0D) d6 = d7;
                    else if (3D * d11 < 2D) d6 = d8 + (d7 - d8) * (0.66666666666666663D - d11) * 6D;
                    else d6 = d8;
                }
                int l1 = (int) (d4 * 256D);
                int i2 = (int) (d5 * 256D);
        ...
        for (int i1 = 0; i1 < 50; i1++) method370(i1);
    }
    ...
    private static void method375(int ai[], int i, int l, int i1, int j1, int k1) {
        ...
        if (aBoolean1464) {
            int l1;
            if (aBoolean1462) {
                if (i1 - l > 3) l1 = (k1 - j1) / (i1 - l);
                else l1 = 0;
                if (i1 > DrawingArea.centerX) i1 = DrawingArea.centerX;
                if (l < 0) {
                    j1 -= l * l1;
                    l = 0;
                }
                ...
                i += l;
                k = i1 - l >> 2;
                if (k > 0) l1 = (k1 - j1) * anIntArray1468[k] >> 15;
                else l1 = 0;
            }
            if (anInt1465 == 0) {
                while (--k >= 0) {
    ...
    private static void method379(
        ...
        if (lowMem) {
            ...
            while (k3-- > 0) {
                int k8;
                if ((k8 = ai1[(j & 0xfc0) + (i >> 6)] >>> i8) != 0) ai[k] = k8;
                k++;
                i += i7;
                j += k7;
                if ((k8 = ai1[(j & 0xfc0) + (i >> 6)] >>> i8) != 0) ai[k] = k8;
            ...
            for (k3 = i1 - l & 7; k3-- > 0; ) {
                int l8;
                if ((l8 = ai1[(j & 0xfc0) + (i >> 6)] >>> i8) != 0) ai[k] = l8;
                k++;
                i += i7;
                j += k7;
            }
        ...
        while (k3-- > 0) {
            int i9;
            if ((i9 = ai1[(j & 0x3f80) + (i >> 7)] >>> j8) != 0) ai[k] = i9;
            k++;
            i += j7;
            j += l7;
            if ((i9 = ai1[(j & 0x3f80) + (i >> 7)] >>> j8) != 0) ai[k] = i9;
        ...
        for (int l3 = i1 - l & 7; l3-- > 0; ) {
            int j9;
            if ((j9 = ai1[(j & 0x3f80) + (i >> 7)] >>> j8) != 0) ai[k] = j9;
            k++;
            i += j7;
            j += l7;
        }
    ...
    static {
        ...
        for (int j = 1; j < 2048; j++) anIntArray1469[j] = 0x10000 / j;
