...
public final class Sprite extends DrawingArea {
    ...
    public void method344(int i, int j, int k) {
        for (int i1 = 0; i1 < myPixels.length; i1++) {
            ...
            if (j1 != 0) {
                ...
                k1 += i;
                if (k1 < 1) k1 = 1;
                else if (k1 > 255) k1 = 255;
                int l1 = j1 >> 8 & 0xff;
                l1 += j;
                if (l1 < 1) l1 = 1;
                else if (l1 > 255) l1 = 255;
                int i2 = j1 & 0xff;
                i2 += k;
                if (i2 < 1) i2 = 1;
    ...
    public void method345() {
        ...
        for (int j = 0; j < myHeight; j++) {
            System.arraycopy(
                    myPixels, j * myWidth, ai, j + anInt1443 * anInt1444 + anInt1442, myWidth);
        }
    ...
    public void method346(int i, int j) {
        ...
        if (j + j1 > DrawingArea.bottomY) j1 -= (j + j1) - DrawingArea.bottomY;
    ...
    private void method347(int i, int j, int k, int l, int i1, int k1, int ai[], int ai1[]) {
        ...
        for (int i2 = -k; i2 < 0; i2++) {
            ...
            for (int k2 = j; k2 < 0; k2++) ai1[i++] = ai[i1++];
    ...
    public void drawSprite1(int i, int j) {
        ...
        if (j + k1 > DrawingArea.bottomY) k1 -= (j + k1) - DrawingArea.bottomY;
        if (i < DrawingArea.topX) {
    ...
    public void drawSprite(int i, int k) {
        ...
        if (k + j1 > DrawingArea.bottomY) j1 -= (k + j1) - DrawingArea.bottomY;
        if (i < DrawingArea.topX) {
            int k2 = DrawingArea.topX - i;
            k1 -= k2;
            i = DrawingArea.topX;
    ...
    public void method354(Background background, int i, int j) {
        ...
        if (i + i1 > DrawingArea.bottomY) i1 -= (i + i1) - DrawingArea.bottomY;
